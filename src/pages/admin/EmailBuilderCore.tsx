...
interface EmailBuilderCoreProps {
  canvasRef: (node: HTMLDivElement | null) => void;
  wrapperStyle?: React.CSSProperties;
}

export function EmailBuilderCore({ canvasRef, wrapperStyle }: EmailBuilderCoreProps) {
  ...
  return (
    <div className="email-builder-wrapper" style={style}>
      <main className="app-body">
        ...
        <aside className="sidebar" id="main-sidebar">
            ...
            <div id="tab-content" className="tab-panel active">
              <div className="blocks-grid">
                ...
                <div className="block-item" draggable={true} data-type="social">
                  <svg width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M8.684 10.742l8.996-4.498m-8.996 9.012l8.996 4.498M21 12a3 3 0 11-6 0 3 3 0 016 0zm-12 6a3 3 0 11-6 0 3 3 0 016 0zm0-12a3 3 0 11-6 0 3 3 0 016 0z"/>
                  </svg>
                  <span>Social</span>
                </div>
            ...
            <div id="tab-rows" className="tab-panel">
              <div className="rows-list">
                ...
                <div className="row-item" draggable={true} data-cols="footer">
                  <div className="row-layout-preview" style={{ background: '#0f0f13', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', borderRadius: 'var(--radius-sm)', gap: '4px' }}>
                    <div style={{ display: 'flex', gap: '4px' }}>
                      <span style={{ color: '#635bff', fontSize: '8px' }}>●</span>
                      <span style={{ color: '#635bff', fontSize: '8px' }}>●</span>
                      <span style={{ color: '#635bff', fontSize: '8px' }}>●</span>
                    </div>
                ...
                <div className="row-item" draggable={true} data-cols="1">
                  <div className="row-layout-preview"><div className="row-col-preview"></div></div>
              ...
              <div className="settings-group">
                ...
                <div className="form-group">
                  ...
                  <div className="slider-container">
                    <input type="range" id="setting-canvas-width" min="480" max="800" defaultValue="600" step="10" />
              ...
              <div className="settings-group">
                ...
                <div className="form-group">
                  ...
                  <div className="color-input-wrapper">
                    <input type="color" id="setting-bg-page" className="color-picker" defaultValue="#f4f4f7" />
                    <input type="text" id="setting-bg-page-text" className="form-input" defaultValue="#f4f4f7" />
                  </div>
                </div>
                <div className="form-group">
                  <label>Cor de Fundo do E-mail</label>
                  <div className="color-input-wrapper">
                    <input type="color" id="setting-bg-email" className="color-picker" defaultValue="#ffffff" />
                    <input type="text" id="setting-bg-email-text" className="form-input" defaultValue="#ffffff" />
                  </div>
                </div>
                <div className="form-group">
          ...
          <div className="properties-panel" id="properties-panel">
            ...
            <div className="properties-body" id="properties-content"></div>
          </div>
        </aside>
      </main>
      ...
      <div className="modal-overlay" id="icon-library-modal">
        <div className="modal-content" style={{ maxWidth: '700px', height: '80vh' }}>
          ...
          <div className="modal-body" style={{ display: 'flex', flexDirection: 'column', gap: '15px', overflow: 'hidden' }}>
            ...
            <div id="icon-library-grid" style={{ flex: 1, overflowY: 'auto', display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: '12px', padding: '5px' }}></div>
          </div>
        </div>
      </div>
